...
export function Sidebar({ collapsed, setCollapsed, currentView = 'live', setCurrentView }: SidebarProps) {
  const { logout } = useAuth();
  const navItems = [
    { id: 'live', icon: LayoutDashboard, label: "Live View", active: currentView === 'live' },
